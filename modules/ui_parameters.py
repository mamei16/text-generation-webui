                ...
                with gr.Column():
                    with gr.Row():
                        ...
                        with gr.Column():
                            ...
                            shared.gradio['adaptive_target'] = gr.Slider(0.0, 1.0,
                                                                         value=shared.settings['adaptive_target'],
                                                                         step=0.01, label='adaptive_target',
                                                                         info='Target probability for adaptive-p sampling. Tokens near this probability are favored. 0 disables.')
                            shared.gradio['adaptive_decay'] = gr.Slider(0.0, 0.99,
                                                                        value=shared.settings['adaptive_decay'],
                                                                        step=0.01, label='adaptive_decay',
                                                                        info='EMA decay rate for adaptive-p. Controls history window (~1/(1-decay) tokens). Default: 0.9.')
                            ...
                            shared.gradio['sampler_priority'] = gr.DragDrop(value=shared.settings['sampler_priority'],
