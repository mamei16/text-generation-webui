    ...
    with gr.Tab("Session", elem_id="session-tab"):
        with gr.Row():
            ...
            with gr.Column():
                ...
                shared.gradio['save_settings'] = gr.Button('Save extensions settings to user_data/settings_mytweaks.yaml', elem_classes='refresh-button', interactive=not mu)
        ...
        if not mu:
            shared.gradio['save_settings'].click(
                ...
                gradio('save_contents', 'save_filename', 'save_root', 'file_saver'), show_progress=False)
