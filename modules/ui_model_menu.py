                    ...
                    with gr.Row():
                        ...
                        with gr.Column():
                            ...
                            with gr.Accordion("Speculative decoding", open=False, elem_classes='tgw-accordion') as shared.gradio['speculative_decoding_accordion']:
                                ...
                                shared.gradio['spec_type'] = gr.Dropdown(label="spec-type",
                                                                         choices=['none', 'ngram-mod', 'ngram-simple',
                        ...
                        with gr.Row():
                            with gr.Column():
                                ...
                                shared.gradio['batch_size'] = gr.Slider(label="batch_size", minimum=1, maximum=4096, step=1, value=shared.args.batch_size,
                                                                        info="For MOE models, increasing this value to 1024 will significantly increase prompt processing speed at the cost of a little more VRAM usage.")
                                shared.gradio['ubatch_size'] = gr.Slider(label="ubatch_size", minimum=1, maximum=4096,
                                                                         step=1, value=shared.args.ubatch_size)
...
def create_event_handlers():
    ...
    shared.gradio['load_model'].click(
        ...
        handle_load_model_event_final, gradio('truncation_length', 'loader', 'interface_state'), gradio('truncation_length', 'filter_by_loader', 'jinja_controls_separator', 'reasoning_effort', 'enable_thinking', 'preserve_thinking'), show_progress=False).then(
...
def update_model_status_indicator(model_load_result):
    if model_load_result is None or model_load_result.startswith("###"):
