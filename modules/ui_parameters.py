                ...
                with gr.Column():
                    with gr.Row():
                        ...
                        with gr.Column():
                            ...
                            shared.gradio['max_updates_second'] = gr.Slider(value=shared.settings['max_updates_second'], minimum=0, maximum=500, step=1, label='Maximum UI updates/second', info='Lower this if UI lags behind text generation during streaming.')
